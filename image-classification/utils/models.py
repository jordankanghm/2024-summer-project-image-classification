...
and dropout.
Below are the averaged test statistics.
...
class ImprovedCNN(nn.Module):
    ...
    """
    Hyperparameter tuning found that the best parameters for the simple CNN model are as follows.
    Best hyperparameters: {'lr': 7.05595685048271e-05, 'dropout_rate': 0.45328103330496955}
    
    The following show the averaged test statistics when tested using the test set.
    Accuracy: 0.9907
    Precision: 0.9909
    Recall: 0.9905
    F1: 0.9907
